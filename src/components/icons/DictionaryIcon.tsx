interface IDictionaryIconProps {
  size: number;
  color: string;
  onClickDictionary?: () => void;
}

const DictionaryIcon = ({ size, color, onClickDictionary }: IDictionaryIconProps) => {
  return (
    <button onClick={onClickDictionary} className="description__dictionary-icon-button icon-button">
      <svg
        fill={color}
